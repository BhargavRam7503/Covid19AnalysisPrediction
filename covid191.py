...
#Vaccine Graphs
#Vaccine Graph - 1
vaccine_data_y1 = df_vaccine_statewise[indian_vaccine_data]["Total Individuals Vaccinated"]
fig5 = px.line(x = vaccine_data_x1, y = vaccine_data_y1,color_discrete_sequence=px.colors.qualitative.Dark2,
       title="Total Individuals Vaccinated")
...
if(option== "Cases"):
        ...
        with updated_table:
            ...
            st.subheader("As on "+str(datelist[-1]))
            st.subheader("")
